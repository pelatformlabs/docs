---
title: "Introduction"
description: "Comprehensive documentation for Pelatform tools, utilities, and UI components"
mode: "frame"
keywords: ["overview", "pelatform", "getting started", "features"]
---
...
<div className="relative">
  ...
  <div className="relative z-10 px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      Complete documentation for Pelatform development tools, utilities, and UI components. Build modern applications faster with our comprehensive suite of developer tools.
    </div>
    ...
    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      <HeroCard
        filename="rocket"
        title="Quickstart"
        description="Get started with Pelatform tools and UI with our comprehensive setup guide"
        href="/quickstart"
      />
      ...
      <HeroCard
        filename="cli"
        title="Toolkits"
        description="Development tools including ESLint, TypeScript, Biome configs, email, storage, and utilities"
        href="/toolkits"
      />
      ...
      <HeroCard
        filename="editor"
        title="UI Core"
        description="Core utilities including general functions, React hooks, icons, and component types"
        href="/ui"
      />
      ...
      <HeroCard
        filename="components"
        title="UI Components"
        description="150+ React components organized by animation, base, aria, and default packages"
        href="/ui/components"
      />
    </div>
  </div>
